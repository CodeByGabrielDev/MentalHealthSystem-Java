...
public class Movimentacao {
	...
	/*
	 * ID int(11) AI PK DATA_MOVIMENTACAO date VALOR decimal(10,2) ID_CLIENTE
	 * int(11) DESCRICAO varchar(200) TIPO varchar(50) FORMA_PGTO varchar(40)
	 * FATURADA tinyint(4) ID_PSICOLOGO int(11) ID_CONVENIO int(11) ESTORNADA
	 * tinyint(4)
	 */
